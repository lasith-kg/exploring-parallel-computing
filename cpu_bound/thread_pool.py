...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Simulate CPU-bound tasks with ThreadPoolExecutor.")
...
def summary(args):
    print("Operation Type: CPU Bound Simulation with ThreadPoolExecutor")
