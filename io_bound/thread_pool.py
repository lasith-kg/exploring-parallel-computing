...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Simulate I/O-bound tasks with ThreadPoolExecutor.")
...
def summary(args):
    print("Operation Type: I/O Bound Simulation with ThreadPoolExecutor")
...
if __name__ == '__main__':
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=num_workers) as executor:
        for i in range(num_tasks):
            # Simulate I/O-bound tasks concurrently using ThreadPoolExecutor
